...
path = r'G:\Academic\ML\Sentiment-Analysis-of-Text\SVM\Imdb'
dataset = load_files(path, shuffle= False, decode_error='ignore', random_state=None,load_content=True)
trainData,testData,trainTarget,testTarget = train_test_split(dataset.data,dataset.target,train_size  = 0.85, test_size=0.15,random_state=45);
